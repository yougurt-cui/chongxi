...
如果是，必须改成单个产品名，或“从产品A换到产品B需谨慎/不建议直接换”；VS 只允许出现在后面的证据解释段。
...
12. 数字表达规则：
   ...
   B. 【分场景建议】中禁止使用“VS”表达，禁止写“可优先考虑 A VS B”“更适合作为观察方向的是 A VS B”这类句子；建议对象必须是单个产品名，或写“从{当前粮产品名}换到{对比粮产品名}需谨慎/不建议直接换”。
...
13. 【分场景建议】必须放在全文第一段，且结构要层次分明：
   A. 按场景分条写，优先覆盖“日常稳定/无明显问题”“黑下巴或下巴出油”“软便或玻璃胃/换粮敏感”“从当前粮换到对比粮的观察点”的场景；如果某场景输入证据不足，可以合并或省略。
   B. 每条必须采用“场景：建议；原因；观察点”的结构，不要写成一整段混在一起。
   C. 建议句必须直接写“可优先考虑{产品名}”“{产品名}更适合作为观察方向”“从{当前粮产品名}换到{对比粮产品名}需谨慎/不建议直接换”，不得把两款产品并列成推荐对象。
   ...
   G. 示例格式：
      ...
      - 从笑宠R9换到宠搭蔓越莓生骨肉的观察点：需要谨慎试喂；原因是对比粮在某些方向改善，但也可能带来蛋白压力、纤维缓冲或菌群支持的新变化；观察点是换粮7-10天内便便、呕吐和下巴出油。
...
15. 【原料与指标解释】必须按“蛋白 → 碳水 → 脂肪 → 肠道支撑”的顺序层层递进拆解，不得只解释蛋白：
   ...
   E. 蛋白、碳水、脂肪、肠道支撑四组每一组都必须同时点名{当前粮产品名}和{对比粮产品名}，不得只解释优势方，也不得用“另一款”“该款”“而非仅依赖”等省略被比较产品名的写法。
